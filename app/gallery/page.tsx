...
export default function Gallery() {
  const [bigData, setBigData] = useState<ProjectBigviewData | undefined>(undefined);
          ...
          projects={[
            {
              ...
              bigDesc: "Sand game. Big Desc i know.",
            },
            {
              title: "PySnake",
              images: [
              ...
              bigDesc: "COC Tech Club Game Dev's 2024 snake game programmed in pure Python! Control the snake with the arrow keys to capture fruits increasing your score. If you hit the walls you lose! What's your high score?"
            },
            {
              ...
              desc: "Game Dev's 2024 PySnake project!",
              bigDesc: "The COC Tech Club Web Dev team's first website made in 2024! A home website for the COC Tech Club made entirely in React utilizing Google Firebase as a backend to dynamically load Projects and Events and handle Join submissions."
            },
            {
              ...
              bigDesc: "COC Tech Club Game Dev presents their 2024 volleyball game! Programmed with Unity with C#, two players can duke it out on a sandy volleyball field battling to score the most points."
            }
          ]}
        />
        <PhotoSection
