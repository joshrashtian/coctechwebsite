...
const CodeNavBar = () => {
  ...
  return (
    <div
      className="fixed backdrop-blur-2xl bg-gradient-to-b from-zinc-50/75 to-zinc-100/75 dark:from-zinc-900/85 dark:to-zinc-950/85
        z-90 top-0 left-0 h-16 w-full flex justify-start px-6 items-center gap-8 text-xl text-black dark:text-white font-mono"
    >
